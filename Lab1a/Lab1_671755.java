...
public class Lab1_671755 {
    ...
    static void task3() {
     ...
     static void task4() { // set element is unique (class Dog and enum Breed)
        ...
        List<String> lis4a = new ArrayList<>(Arrays.asList("Lily", "Daisy", "Tulip", "Daisy"));
        HashSet<String> flowers = new HashSet<>(lis4a);
        for (var ele: flowers)
            System.out.print(ele + " ");
        System.out.println(); // Tulip Daisy Lily

        List<Dog> lis4b = new ArrayList<>(Arrays.asList(new Dog(Breed.pomeranian,1200),
    ...
    static void task5() { // number of unique element
        ...
        List<Dog> lis5a = new ArrayList<>(Arrays.asList(new Dog(Breed.pomeranian,1200),
                                new Dog(Breed.beagle, 2300), new Dog(Breed.jack,1440),
                                new Dog(Breed.beagle, 2300)
                            ));
        /* your code */
        HashSet<Dog> distinct_dogs=new HashSet<>(lis5a);
        System.out.println( distinct_dogs.size() ); // 3
    }
    static void task6() { // count same elements
        System.out.println("-task6----");
        List<Dog> lis6a = new ArrayList<>(Arrays.asList(new Dog(Breed.pomeranian,1200),
                                new Dog(Breed.beagle, 2300), new Dog(Breed.jack,1440),
                                new Dog(Breed.beagle, 2300)
                            ));
